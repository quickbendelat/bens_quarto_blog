...
To achieve that keeping the table top flat, I needed some supports that would span across the hinge and be removable. My solution was to use T-nuts counter sunk in from the top, with eye bolts from below that can be unscrewed to detach. I used an 18mm dowel 1200mm long to perfectly span the hinge and reach end to end for support. However, there was still a gap between the underside of the table and the dowel, which resulted in the top still drooping a little. The gap was about 40mm which meant that a 40mm pinetrim was perfect to wedge in place (no extra method to attache was required).
...
<br><br>
<img src="https://goatcounter.com/posts/gaming-table/.svg?no_branding=true" alt="Views" style="display: inline-block; vertical-align: middle; height: 20px;">
